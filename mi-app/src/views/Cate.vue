				...
				<div v-for="item in cateInfo">
					...
					<div v-if="item.body.product_list">
						<div class="category_group"
						 v-for="groupItem in item.body.product_list"
						  @click="$router.push('/details/'+groupItem.action.path)"
						  :key="groupItem.product_id"
						  >
						  11
							<img v-lazy="groupItem.puzzle_url"
							:style="{
								    'width':' 1.33rem',
								    'height': '1.33rem'
							}">
